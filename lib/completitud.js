// Umbral mínimo de completitud para aparecer en /api/buscar y
// /api/recomendaciones. Antes era 50 (exigía casi el perfil entero), lo que
// dejaba invisibles a los usuarios recién registrados frente a los perfiles
// demo (sembrados ya al 100%). Bajado a 25 = basta con tener la foto de
// avatar aprobada (se aprueba al instante al subirla), que ya es el único
// requisito real dado que ambos endpoints exigen además una foto aprobada.
export const UMBRAL_BUSQUEDA = 25;
