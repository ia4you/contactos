// Publicaciones por página en /perfil/[nick] (SSR inicial y GET
// /api/perfil/[nick]/publicaciones). No puede vivir en PublicacionesPerfil
// (client component): un Server Component que importe una constante de un
// módulo "use client" recibe una referencia opaca de React, no el valor
// real — de ahí un bigint inválido en la query al usarla como LIMIT.
export const PUBLICACIONES_PERFIL_LIMITE = 12;
